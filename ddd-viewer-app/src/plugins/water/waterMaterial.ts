...
export class WaterMaterial extends PushMaterial {
    ...
    */
    ...
    public isReadyForSubMesh( mesh: AbstractMesh, subMesh: SubMesh, useInstances?: boolean ): boolean {
        ...
        let defines = <WaterMaterialDefines>subMesh._materialDefines;
        ...
        if ( defines.isDirty ) {
            ...
            // Fallbacks
            let fallbacks = new EffectFallbacks();
            if ( defines.FOG ) {
            ...
            //Attributes
            let attribs = [ VertexBuffer.PositionKind ];
            ...
            let uniformBuffers = new Array<string>();
    ...
    private _createRenderTargets( scene: Scene, renderTargetSize: Vector2 ): void {
        ...
        this._refractionRTT.onBeforeRender = () => {
            ...
            if ( !this.disableClipPlane ) {
                ...
                let positiony = this._mesh ? this._mesh.position.y : 0.0;
    ...
    public static Parse( source: any, scene: Scene, rootUrl: string ): WaterMaterial {
        let mat = SerializationHelper.Parse(() => new WaterMaterial( source.name, scene ), source, scene, rootUrl );
    ...
    public static CreateDefaultMesh( name: string, scene: Scene ): Mesh {
        let mesh = Mesh.CreateGround( name, 512, 512, 32, scene, false );
        return mesh;
    }
}
